...
const FloatingWhatsApp = () => {
  ...
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.9 }}
      className="fixed bottom-8 left-8 md:left-auto md:right-8 z-[60] bg-accent-500 text-white p-4 rounded-full shadow-2xl flex items-center justify-center group"
    >
